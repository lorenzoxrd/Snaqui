...
def juego():
    ...
    while estado_juego == GameState.PLAYING:
                    ...
                    if not game_started:
                        ...
                        if not paused:
                            if (event.key == pygame.K_RIGHT or event.key == pygame.K_d) and direccion != "izquierda":
                                ...
                                direccion = "abajo"
            # Manejar clics en botones durante la pausa
        ...
        if not game_started:
            dibujar_texto("Presione una tecla de dirección para comenzar", 20, BLANCO, ANCHO//2, ALTO//2)
        elif paused:
            ...
            dibujar_texto("PAUSADO", 50, BLANCO, ANCHO//2, ALTO//4)
            ...
            # Actualizar colores según hover
            mouse_pos = pygame.mouse.get_pos()
            boton_reiniciar.color_actual = boton_reiniciar.color_hover if boton_reiniciar.esta_sobre(mouse_pos) else boton_reiniciar.color_normal
            boton_menu.color_actual = boton_menu.color_hover if boton_menu.esta_sobre(mouse_pos) else boton_menu.color_normal
            boton_salir.color_actual = boton_salir.color_hover if boton_salir.esta_sobre(mouse_pos) else boton_salir.color_normal
